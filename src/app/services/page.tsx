...
export const metadata: Metadata = {
  title: "Services | Extractors Junk Removal",
  description: "Every service Extractors offers across Orange County and LA County — junk removal, cleanouts, light demolition, and commercial.",
  ...
  return (
    <>
      <Hero
        ...
        title="What Extractors Junk Removal Does"
        subtitle="Junk removal, cleanouts, light demolition, and commercial accounts — one crew, one trailer, one upfront price."
        showRating={false}
      />
