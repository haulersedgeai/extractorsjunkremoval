...
export const metadata: Metadata = {
  title: "Why Choose Extractors | OC & LA County Junk Removal",
  description: "Family-owned, upfront pricing, five-star reviews, fully licensed and insured. Here&apos;s why Orange County and LA County keep picking Extractors.",
...
const US = [
  ...
  "COI on file for property managers",
  "Real Cypress number — answered by a real person",
  "Licensed for BOTH junk removal AND light demolition",
];

const THEM = [
  "Vague \"call for pricing\" estimates",
  "Slow-roll quotes that take days",
  "Out-of-state franchises with no local accountability",
  "Surprise fees at the curb",
  "Voicemail-only customer service",
  "Crews you can't vet or verify",
  "Outsourced call centers",
  "Demolition? \"Not us, call someone else.\"",
];
...
export default function WhyChooseUsPage() {
  return (
    <>
      <Hero
        eyebrow="Why Us"
        title="Why OC & LA Keep Calling Extractors"
        subtitle="No franchise overhead. No surprise fees. No middlemen. Just a Cypress-local crew that shows up and does the job right."
      />
      ...
      <Section>
        ...
        <h2 className="mt-2 font-display text-3xl font-extrabold text-ink sm:text-4xl">
          Extractors vs. the other guys
        </h2>
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border-2 border-brand bg-cream p-6">
            <div className="text-sm font-bold uppercase tracking-wider text-brand">Extractors Junk Removal</div>
