      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-6">
          <div className="lg:col-span-2">
            <div className="text-2xl font-extrabold text-white">
              <span className="text-brand-light">EXTRACTORS</span> Junk Removal
            </div>
            ...
            <ul className="mt-5 space-y-2 text-sm">
              ...
              <li className="inline-flex items-start gap-2">
                ...
                <span>{SITE.address.street}, {SITE.address.locality}, {SITE.address.region} {SITE.address.postal}</span>
              </li>
            </ul>
          ...
          <div>
            <div className="text-sm font-bold uppercase tracking-wide text-accent">Services</div>
          ...
          <div>
            <div className="text-sm font-bold uppercase tracking-wide text-accent">Orange County</div>
            <ul className="mt-3 space-y-2 text-sm">
              {OC_LOCATIONS.slice(0, 10).map((c) => (
                <li key={c.slug}>
          ...
          <div>
            <div className="text-sm font-bold uppercase tracking-wide text-accent">LA County</div>
            <ul className="mt-3 space-y-2 text-sm">
              {LA_LOCATIONS.slice(0, 10).map((n) => (
                <li key={n.slug}>
          ...
          <div>
            <div className="text-sm font-bold uppercase tracking-wide text-accent">Company</div>
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="/about" className="text-cream/80 hover:text-white">About</Link></li>
              <li><Link href="/why-choose-us" className="text-cream/80 hover:text-white">Why Choose Us</Link></li>
              ...
              <li><Link href="/pricing" className="text-cream/80 hover:text-white">Pricing</Link></li>
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-3 border-t border-cream/10 pt-6 text-sm text-cream/60 md:flex-row md:items-center">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-2">
            <span>© {new Date().getFullYear()} {SITE.legal}. Licensed & insured in California.</span>
          </div>
