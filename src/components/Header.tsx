  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-ink/10 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="font-display text-xl font-extrabold tracking-tight text-ink transition-colors hover:text-brand sm:text-2xl">
          <span className="text-brand">EXTRACTORS</span>
          <span className="ml-1 text-ink/70 text-sm font-bold hidden sm:inline">Junk Removal</span>
        </Link>
