    ...
    return (
      <div className="rounded-xl border-2 border-brand bg-cream p-6 text-center">
        ...
        <p className="mt-4 text-sm text-ink/60">
          Faster route: text <a className="font-bold text-brand" href={`sms:${SITE.smsRaw}`}>{SITE.phoneDisplay}</a>.
        </p>
      </div>
    );
  }
    ...
    <form action={action} className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <Input id="phone" name="phone" type="tel" required placeholder="(562) 555-0123" />
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <Input id="zip" name="zip" inputMode="numeric" placeholder="90630" />
        </div>
      </div>
      ...
      <p className="text-xs text-ink/60">
        By submitting, you agree to be contacted by Extractors Junk Removal about your quote. We don&apos;t share your info.
      </p>
    </form>
  );
}
