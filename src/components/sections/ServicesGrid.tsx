...
import { ArrowRight, Truck, Hammer, Home, Building2 } from "lucide-react";
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-ink/70">
            One crew, one truck, four service lines. Family-owned in Cypress and rolling across Orange County and LA County every day.
          </p>
        </div>
